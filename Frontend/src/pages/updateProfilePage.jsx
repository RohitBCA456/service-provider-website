...
export default function UpdateProfile() {
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        const response = await axios.get("https://service-provider-roan.vercel.app/api/v1/auth/getCurrentUser", {
    ...
    try {
      ...
      const endpoint =
        displayData.role === "provider"
          ...
          : "https://service-provider-roan.vercel.app/api/v1/customers/updateCustomer"
